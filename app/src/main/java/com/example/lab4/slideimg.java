...
public class slideimg extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView n = (TextView) findViewById(R.id.textView6);                                        //on sale font
        n.setTypeface(Typeface.createFromAsset(getAssets(), "salter.ttf"));

        Toast.makeText(slideimg.this, "橙廚義大利麵",                                     //剛進去橙廚義大利麵無法進到SWITCH做判斷
                Toast.LENGTH_SHORT).show();                                                          //故先加入這行CODE預先顯示

        AnimationSet animationSet3 = new AnimationSet(true);                         //on sale animation
