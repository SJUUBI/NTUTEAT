...
public class mealtest5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startActivityForResult(new Intent(mealtest5.this,
                louisamenu.class),1);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivityForResult(new Intent(mealtest5.this,                  //將頁面轉到餐廳優惠快報圖片頁面(slideimg)
                        apimap.class), 1);
